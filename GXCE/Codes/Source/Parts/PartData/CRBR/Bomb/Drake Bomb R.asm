...
PartDescription:
    String|
"Ground: Fires quickly in an 
arc. Larger blast.
Air: Fires straight slowly.
Larger blast.
...
0x0000 #Empty Data? 
float [3] |
1.25, | #Explosion Size after Initial Expansion 
1.50, | #Final Explosion Size 
0.55 #Explosion Height 
half [10] |
53, | #Damage 
375, | #Down 
